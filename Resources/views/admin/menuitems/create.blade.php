        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ trans('menu::menu.breadcrumb.create menu item') }}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-9">
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-danger float-right" href="{{ route('admin.menu.menu.edit', [$menu->id])}}"><i class="fa fa-times"></i> {{ trans('core::core.button.cancel') }}</a>
            </div>
        </div>
...
$( document ).ready(function() {
    ...
    $('[name="link_type"]').iCheck({
        checkcardClass: 'icheckcard_minimal',
